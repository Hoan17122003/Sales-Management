...
namespace SV21T1020885.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public IActionResult ChangePasswordPost(string oldPassword, string newPassword, string confirmPassword)
        {
            ...
            if (newPassword == confirmPassword)
            {
                ...
                var userDataSession = User.GetUserData();
                var user = UserAccountService.ChangePassword(userDataSession.Email, oldPassword, newPassword);
                result = true;
                return RedirectToAction("Index", "Home");
            }
