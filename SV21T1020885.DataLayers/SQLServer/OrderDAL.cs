...
namespace SV21T1020885.DataLayers.SQLServer
{
    public class OrderDAL : _BaseDAL, IOrderDAL
    {
        ...
        public int Count(int status = 0, DateTime? fromTime = null, DateTime? toTime = null, string searchValue = "")
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                {
                    Status = status,
                    FromTime = fromTime,// so sanh form time cua sql vs Datetime 
                    ToTime = toTime,
                    SearchValue = searchValue
                };
        ...
        public bool DeleteDetail(int orderID, int productID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                var parameter = new { OrderID = orderID, ProductID = productID };
                result = connection.Execute(sql: sql, param: parameter, commandType: CommandType.Text) > 0;
                connection.Close();
            }
            return result;
        ...
        public Order? Get(int orderID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                var parameter = new { OrderID = orderID };
                data = connection.QueryFirstOrDefault<Order>(sql: sql, param: parameter, commandType: CommandType.Text);
                connection.Close();
            }
            return data;
        }
        ...
        public OrderDetail? GetDetail(int orderID, int productID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                var parameter = new { OrderID = orderID, ProductID = productID };
                data = connection.QueryFirstOrDefault<OrderDetail>(sql: sql, param: parameter, commandType: CommandType.Text);
                connection.Close();
            }
            return data;
        }
        ...
        public IList<Order> List(int page = 1, int pageSize = 0, int status = 0, DateTime? fromTime = null, DateTime? toTime = null, string searchValue = "")
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                list = connection.Query<Order>(sql:sql, param:parameter, commandType: CommandType.Text).ToList();
                connection.Close();
            }
            return list;
        }
        ...
        public IList<OrderDetail> ListDetails(int orderID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                var parameter = new {OrderID = orderID};
                list = connection.Query<OrderDetail>(sql:sql, param:parameter, commandType:CommandType.Text).ToList() ;
                connection.Close();
            }
            return list;
        }
        ...
        public bool SaveDetail(int orderID, int productID, int quantity, decimal salePrice)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                var parameter = new { OrderID = orderID, ProductID = productID, Quantity = quantity, SalePrice = salePrice };
                result = connection.Execute(sql:sql, param : parameter, commandType:CommandType.Text)>0;
                connection.Close();
            }
            return result;
